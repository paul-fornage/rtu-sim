    ...
    loop {
        ...
        match &test_case {
            TestCases::SrSingle(index) => {
                ...
                match sr_single_shared(&mut ctx, *index).await {
            ...
            TestCases::SrUpTo(index) => {
                ...
                for i in 0..=*index {
                    match sr_single_shared(&mut ctx, i).await {
                        Ok(_) => {
            ...
            TestCases::SrOutOfBounds => {
                ...
                match sr_single_shared(&mut ctx, 65535).await {
            ...
            TestCases::SrEarlyStopWithDelay(idx, delay) => {
                ...
                match sr_single_early_stop_shared(&mut ctx, *idx, Duration::from_millis(*delay as u64)).await {
            ...
            TestCases::SrEarlyStopWithDelayOnAllUpTo(idx, delay) => {
                ...
                for i in 0..=*idx {
                    match sr_single_early_stop_shared(&mut ctx, i, Duration::from_millis(*delay as u64)).await {
            ...
            TestCases::SrEarlyStopAllDelays(idx) => {
                ...
                loop {
                    ...
                    match sr_single_early_stop_shared(&mut ctx, *idx, delay).await {
